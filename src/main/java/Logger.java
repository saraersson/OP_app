public class Logger {
    ...
    void length() {
        System.out.println("[V] criteria: " + this.pn.input +" is between 10 and 13.");
    }

    void format() {
        switch(this.pn.input.length()) {
            case 10:
                System.out.println("[V] format: " + this.pn.input + " is in the format YYMMDDXXXX");
                break;
            case 11:
                System.out.println("[V] format: " + this.pn.input + " is in the format YYMMDD-XXXX");
                break;
            case 12:
                System.out.println("[V] format: " + this.pn.input + " is in the format YYYYMMDDXXXX");
                break;
            case 13:
                System.out.println("[V] format: " + this.pn.input + " is in the format YYYYMMDD-XXXX");
                break;
            default:
    ...
    void format(final char separator) {
        if (separator == '/') {
            ...
            System.out.println("[V] format: " + this.pn.input + " is in the format YYMMDD" + separator + "XXXX");
        }
    ...
    void parsed() {
        System.out.println("[V] parse result: " + this.pn.input + " --> " + this.pn.fixed);
        System.out.println();
    }
    ...
    void isRegular(final boolean valid) {
        if(valid) {
            System.out.println("[V] result: " + this.pn.fixed + " is a valid regular number");
        }
        else {
            System.out.println("[X] result: " + this.pn.fixed + " is NOT a regular number");
            System.out.println();
        }
    }
    ...
    void valid(final boolean valid) {
        System.out.println();
        if(valid) {
            System.out.println("[V] final result: " + this.pn.fixed + " is a valid social security number");
        }
        else {
            System.out.println("[X] final result: " + this.pn.fixed + " is a NOT valid social security number");
        }
    ...
    void isCoordination(final boolean valid) {
        if(valid) {
            System.out.println("[V] result: " + this.pn.fixed + " is a valid coordination number");
            System.out.println();
        }
        else {
            System.out.println("[X] result: " + this.pn.fixed + " is NOT a valid coordination number");
            System.out.println();
        }
    }
    ...
    void isOrganisation(final boolean valid) {
        if(valid) {
            System.out.println("[V] result: " + this.pn.fixed + " is a valid organisation number");
            System.out.println();
        }
        else {
            System.out.println("[X] result: " + this.pn.fixed + " is NOT a valid organisation number");
            System.out.println();
        }
    }
    ...
    void luhns(final int luhns, final boolean matches) {
        if(matches) {
            System.out.println("[V] criteria: the calculated control number (" + luhns + ") of " + this.pn.fixed + " matches given control number (" + this.pn.getControlNumber() + ")");
        }
        else {
    ...
    void prefixOrLength(final boolean correct) {
        if(correct) {
            System.out.println("[V] criteria: either the prefix (" + this.pn.getPrefix() + ") of " + this.pn.fixed + " is valid, or the length is 11");
        }
        else {
